...
const Stars = () => (
  <div className="flex gap-1">
    {Array.from({ length: 5 }).map((_, i) => (
      <Star key={i} className="h-4 w-4 fill-[#d6dbe1] text-[#d6dbe1]" />
    ))}
  </div>
);
    ...
    <div className="grid gap-6 md:grid-cols-3">
      {REVIEWS.map((r, i) => (
        <motion.figure
          ...
          className="group relative flex flex-col rounded-2xl border border-[#d6dbe1]/20 bg-gradient-to-b from-[#111] to-black p-8 transition-all duration-500 hover:border-[#d6dbe1]/50 hover:shadow-[0_0_40px_rgba(214,219,225,0.08)]"
        >
          <Quote className="mb-5 h-8 w-8 text-[#d6dbe1]/40" />
